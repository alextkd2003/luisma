    ...
    return (
        <Navbar style={{height: '58px', backgroundColor: '#ff5252'}} className="py-0 my-0 align-items-start flex-column fixed-top">
            ...
            <div className="d-flex justify-content-center align-items-center">
                ...
                <p className="text-white pt-0 m-0 ml-2">call me at <a className="py-0 px-2 text-white shadow" style={{border: '1px solid #ec4a4a'}} href="tel:+15555555555">{
                        contacts[0] && contacts[0].acf.phonenumber
                    }</a></p>
            </div>
        </Navbar>
    )
